...
<head>
    ...
    <title>todos Documentation</title>
    ...
    <script>
        var tryItOutBaseUrl = "todos.test";
        var useCsrf = Boolean();
...
<body data-languages="[&quot;php&quot;,&quot;python&quot;,&quot;bash&quot;,&quot;javascript&quot;]">
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    <a href="#endpoints">Endpoints</a>
                                ...
                                <a href="#endpoints-GETapi-user">GET api/user</a>
                                                                                ...
                                                                                <li class="tocify-item level-2" data-unique="endpoints-POSTapi-todos">
                                <a href="#endpoints-POSTapi-todos">Store a newly created todo item in storage.</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="endpoints-PUTapi-todos--id-">
                                <a href="#endpoints-PUTapi-todos--id-">Update the specified todo record in storage.</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="endpoints-POSTapi-todos">Store a newly created todo item in storage.</h2>
...
url = 'https://todos.test/api/todos'
payload = {
    "name": "this is an example todo item"
}
headers = {
...
<span id="execution-results-POSTapi-todos" hidden>
    ...
    <pre class="json"><code id="execution-response-content-POSTapi-todos"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-todos" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-todos">
...
<form id="form-POSTapi-todos" data-method="POST"
    ...
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    ...
                    onclick="tryItOut('POSTapi-todos');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-todos"
                    onclick="cancelTryOut('POSTapi-todos');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-todos"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Content-Type"                data-endpoint="POSTapi-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="Accept"                data-endpoint="POSTapi-todos"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>string</small>&nbsp;
 &nbsp;
                <input type="text" style="display: none"
               name="name"                data-endpoint="POSTapi-todos"
               value="this is an example todo item"
               data-component="body">
    <br>
<p>The name of the To do item. Example: <code>this is an example todo item</code></p>
        </div>
        </form>

                    <h2 id="endpoints-PUTapi-todos--id-">Update the specified todo record in storage.</h2>
...
url = 'https://todos.test/api/todos/1'
payload = {
    "name": "this is an example todo item",
    "completed": false
}
...
<small>integer</small>&nbsp;
 &nbsp;
               ...
               data-component="url">
    <br>
<p>The ID of the todo. Example: <code>1</code></p>
            </div>
                            <h4 class="fancy-heading-panel"><b>Body Parameters</b></h4>
        <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>name</code></b>&nbsp;&nbsp;
...
<i>optional</i> &nbsp;
                <input type="text" style="display: none"
               name="name"                data-endpoint="PUTapi-todos--id-"
               value="this is an example todo item"
               data-component="body">
    <br>
<p>The name of the To do item. Example: <code>this is an example todo item</code></p>
...
<small>boolean</small>&nbsp;
<i>optional</i> &nbsp;
                <label data-endpoint="PUTapi-todos--id-" style="display: none">
